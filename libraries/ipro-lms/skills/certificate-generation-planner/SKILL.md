...
3. Map eligibility and generation timing, including delayed records, renewals, revocations, and duplicate prevention.
4. Specify layout, accessibility, file format, naming, storage, delivery, download permissions, and retention.
...
- Never imply accreditation or authorization that is not approved.
- Use authoritative records; do not infer eligibility.
