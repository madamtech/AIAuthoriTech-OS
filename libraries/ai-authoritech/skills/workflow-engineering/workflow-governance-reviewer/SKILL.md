...
4. Trace required controls to implementation, tests, monitoring, incidents, owners, and remediation.
5. Review validation, documentation, metrics, change control, continuity, training, and review cadence.
6. Sample transactions and reproduce material control claims where feasible.
