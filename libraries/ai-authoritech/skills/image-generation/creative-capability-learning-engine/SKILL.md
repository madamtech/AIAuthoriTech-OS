...
## Inputs
Request, selected skills, prompts, references, generated outputs, revision history, approval decision, model/tool, and final asset metadata.
...
## QA
Every learned rule must cite its evidence, scope, confidence, and expiration/review condition.

## Recovery
Revert the learning update when it causes regressions and document the counterexample.

## Future expansion
Automated visual similarity scoring, model performance dashboards, and approval-driven promotion from observations to canonical rules.
