...
## Inputs
Audience, channel, visual, text, color palette, instructional purpose, representation requirements, and known accessibility standards.
...
## QA
Test the image at target size, in grayscale where relevant, and without relying solely on color or decorative text.

## Recovery
Simplify hierarchy, increase contrast, replace ambiguous symbols, and correct representation issues before release.
