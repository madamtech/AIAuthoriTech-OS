...
4. Assign stable nonsemantic IDs, preferred labels, synonyms, definitions, scope notes, examples, and exclusions.
...
9. Deliver taxonomy, term records, mappings, test evidence, governance, migration, and open decisions.
