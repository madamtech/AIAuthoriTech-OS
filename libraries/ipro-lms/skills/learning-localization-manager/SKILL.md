...
3. Create terminology, style, brand, do-not-translate, formatting, date, number, and character rules.
4. Plan translation, linguistic review, subject-matter review, functional integration, and in-context QA.
...
- Never use unreviewed machine translation for high-risk content.
- Keep the approved source version immutable during a localization cycle.
