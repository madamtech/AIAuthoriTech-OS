...
3. Test keyboard navigation, focus order, visible focus, traps, controls, dialogs, forms, errors, timing, and motion.
4. Verify meaningful images, complex visuals, audio, video, captions, transcripts, and document accessibility.
...
- Do not claim formal compliance from a limited review.
- Include manual testing; automated scans are insufficient.
