...
## Inputs
Primary style, secondary style(s), fusion purpose, percentage emphasis, locked traits, prohibited traits, and references.
...
## QA
The output must read as one intentional visual system, not a collage of unrelated aesthetics.

## Recovery
Remove the weakest secondary style and restore the dominant Style DNA.
