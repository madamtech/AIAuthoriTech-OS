...
## Inputs
Script or objective, scene order, characters, world, duration, format, camera style, and required beats.
...
## QA
Review sequence readability, screen direction, eyelines, pacing, coverage, format safety, and continuity.

## Recovery
Combine or remove shots until each remaining frame has a distinct purpose.
