...
3. Organize an information hierarchy from headline status through trends, segments, exceptions, and record-level follow-up.
4. Choose visuals that fit the comparison and avoid misleading scales, aggregation, or color.
5. Define filters, drilldowns, thresholds, alerts, annotations, exports, and empty/error states.
...
- Do not display metrics without definitions and owners.
- Aggregate or suppress sensitive small groups.
