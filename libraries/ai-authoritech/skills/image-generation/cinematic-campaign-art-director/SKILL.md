...
## Inputs
Campaign brief, audience, promise, brand, hero subject, channel set, narrative arc, visual references, and deliverable list.
...
## QA
All frames must feel related, support the same promise, preserve brand identity, and remain usable across required formats.

## Recovery
When frames feel disconnected, reduce motifs and lock one lighting/grade system across the campaign.
