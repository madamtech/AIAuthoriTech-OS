...
3. Build only the world rules, supporting characters, and backstory needed to sustain the narrative.
4. Structure the story into acts or sequences with an inciting event, escalating turns, midpoint, crisis, climax, and resolution appropriate to its length.
...
- Do not draft a full screenplay unless requested; route detailed scene writing to `screenplay-builder`.
- Ask one focused question only when a missing choice would materially change the story. Otherwise proceed with labeled assumptions.
- Never present an undeveloped concept as production-ready without identifying its gaps.
