...
description: Calculate governed quote pricing from approved source data and formulas while preserving price-list provenance, renewal logic, approval boundaries, and calculation transparency. Use when asked to (1) control quote pricing and approval, (2) reconcile quote pricing and approval, (3) audit quote pricing and approval, or (4) plan quote pricing and approval.
---
