...
3. Define filters, joins, grouping, calculated fields, exclusions, timezone, and snapshot behavior.
4. Test duplicates, multiple attempts, course versions, renewals, inactive users, missing values, and branch visibility.
...
- Never assume report labels equal business definitions.
- Protect learner and employment data.
