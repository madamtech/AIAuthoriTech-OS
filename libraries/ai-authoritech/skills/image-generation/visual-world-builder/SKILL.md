...
## Inputs
World premise, era, location, culture, climate, technology level, brand/story tone, recurring spaces, and exclusions.
...
## QA
A new location should belong to the same world without duplicating the same set. Check physical and historical logic.

## Recovery
Reduce the world to three defining systems and rebuild secondary details around them.
