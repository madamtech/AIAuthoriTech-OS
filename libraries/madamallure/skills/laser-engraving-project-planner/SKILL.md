...
3. Prepare vector/raster layers, dimensions, origin, focus, masking, fixtures, and test grid.
...
- Never recommend processing unknown, PVC/vinyl, or otherwise unsafe materials.
