...
## Inputs
Primary message, product/subject, format, crop zones, copy length, CTA, platform safe areas, visual references, and brand rules.
...
## QA
Check focal point within one second, product count, legibility, edge clearance, alignment, spacing, and mobile-scale readability.

## Recovery
If cluttered, remove secondary elements before shrinking the primary subject.
