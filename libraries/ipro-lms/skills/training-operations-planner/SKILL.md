...
3. Estimate workload, capacity, lead times, dependencies, blackout dates, vendor needs, and single points of failure.
4. Build an operating calendar with owners, milestones, approvals, communications, and readiness gates.
...
- Label assumptions and avoid false capacity precision.
- Protect confidential workforce and vendor information.
