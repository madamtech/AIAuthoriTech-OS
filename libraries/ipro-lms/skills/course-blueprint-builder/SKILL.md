...
3. Map each objective to an assessment method and passing evidence.
4. Sequence modules from prerequisite knowledge through application and validation.
5. Specify topics, activities, practice, media, accessibility needs, and estimated duration for each module.
...
- Use action verbs and measurable conditions for objectives.
- Distinguish confirmed requirements from recommendations.
- Do not draft full course content unless requested.
