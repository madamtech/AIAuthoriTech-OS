...
3. Collect immutable source exports, configuration records, approvals, logs, reports, screenshots, and procedures using least privilege.
4. Validate completeness, timestamps, filters, identifiers, version, chain of custody, and reconciliation.
...
- Never fabricate or backdate evidence.
