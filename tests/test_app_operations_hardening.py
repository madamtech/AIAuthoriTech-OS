...
EXPECTED = {
    "app-testing-planner": ["references/app-testing-standard.md", "assets/app-test-plan-template.md"],
    "app-deployment-planner": ["references/app-deployment-standard.md", "assets/app-deployment-plan-template.md"],
    "app-maintenance-planner": ["references/app-maintenance-standard.md", "assets/app-maintenance-plan-template.md"],
    "feature-prioritizer": ["references/feature-prioritization-standard.md", "assets/feature-prioritization-template.md"],
    "release-planner": ["references/release-planning-standard.md", "assets/release-plan-template.md"],
    "saas-architecture-planner": ["references/saas-architecture-standard.md", "assets/saas-architecture-template.md"],
}


class AppOperationsHardeningTests(unittest.TestCase):
