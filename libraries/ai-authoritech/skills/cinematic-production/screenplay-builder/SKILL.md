...
3. Draft standard scene headings, filmable action, character cues, dialogue, parentheticals only when essential, and transitions only when meaningful.
4. Give characters distinct voices and use subtext, behavior, and visual storytelling instead of explanatory dialogue.
...
- Avoid camera directions unless essential to comprehension or explicitly requested.
- Route visual panel planning to `storyboard-director` and shot engineering to `cinematic-shot-list-builder`.
- Do not imitate a living screenwriter's distinctive style; describe and apply high-level traits instead.
