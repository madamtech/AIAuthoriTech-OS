...
3. Define the movement family, starting frame, path, direction, speed, easing, parallax, focus, and ending frame.
4. Coordinate performer and environmental motion, screen direction, adjoining shots, and edit point.
...
- Never claim a drone path, vehicle mount, crane, stunt, or rig is safe; require qualified review.
- For generative video, use one dominant move.
