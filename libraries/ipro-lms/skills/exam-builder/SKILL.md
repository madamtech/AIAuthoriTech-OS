...
3. Draft clear stems with one defensible answer and plausible distractors.
4. Add answer keys, rationales, objective tags, difficulty estimates, source references, and sensitivity labels.
...
- Do not invent technical facts or cite unverified sources.
- Keep secure items out of public examples and unsecured files.
