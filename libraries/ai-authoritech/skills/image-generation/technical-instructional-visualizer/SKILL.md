...
## Inputs
Learning objective, source documentation, equipment/interface references, audience skill level, required labels, sequence, and delivery format.
...
## QA
Verify every visible component, label, state, connection, and user action against source material.

## Recovery
When accuracy cannot be confirmed, create a clearly labeled conceptual visualization rather than presenting it as exact.
