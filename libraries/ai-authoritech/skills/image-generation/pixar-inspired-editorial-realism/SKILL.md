...
## Inputs
Identity lock, Style DNA, scene, wardrobe, brand, emotion, realism target, and canonical references.
...
## QA
Compare against canonical Primary-style samples for identity, rendering balance, lighting, skin finish, and emotional warmth.

## Recovery
Lower stylization intensity and re-anchor to the identity reference when drift appears.
