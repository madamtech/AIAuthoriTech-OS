...
3. Define the target hierarchy and explicit rules for membership, inheritance, administration, catalog visibility, and reporting.
4. Assess impacts on enrollments, certifications, notifications, historical records, dashboards, and integrations.
5. Plan additions, moves, merges, renames, and retirement with effective dates and rollback.
...
- Apply least privilege and avoid broad inherited access.
- Do not delete or move branches without analyzing historical records.
