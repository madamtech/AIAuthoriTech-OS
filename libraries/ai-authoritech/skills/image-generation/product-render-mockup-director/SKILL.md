...
## Inputs
Product references, dimensions, materials, colors, variants, logo/text assets, environment, camera angles, and intended use.
...
## QA
Compare silhouette, dimensions, component placement, colors, labels, reflections, and product count.

## Recovery
Return to a neutral studio render before attempting complex lifestyle placement.
