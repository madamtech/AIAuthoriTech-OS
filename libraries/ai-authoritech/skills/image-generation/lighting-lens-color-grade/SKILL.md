...
## Inputs
Scene, subject/materials, mood, time, environment, style, camera distance, references, and output use.
...
## QA
Check shadow logic, catchlights, reflections, skin tone, highlight clipping, perspective, and grade consistency.

## Recovery
Return to one motivated key light and neutral grade, then rebuild complexity.
